...
public class DataCheckActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        age = (CheckBox)findViewById(R.id.checkBox_age);
        use = (CheckBox)findViewById(R.id.checkBox_agree);
        check = (CheckBox)findViewById(R.id.checkBox_data_agree);

        next = findViewById(R.id.imageButton_next);

        fchuse = (TextView)findViewById(R.id.textView8);
        datause = (TextView)findViewById(R.id.textView9);

        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(age.isChecked() && use.isChecked() && check.isChecked()){
                    Intent intent = new Intent(getApplicationContext(), RegisterActivity.class);
                    startActivity(intent);
                } else {
                    Toast.makeText(getApplicationContext(), "모든 사항을 선택해주세요.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    protected void onStart() {
        ...
        fchuse.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder_fchuse = new AlertDialog.Builder(DataCheckActivity.this);
        ...
        datause.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder_datause = new AlertDialog.Builder(DataCheckActivity.this);
